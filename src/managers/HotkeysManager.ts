        ...
        private initializeHotkeys() {
                ...
                this.globalListener = (e: KeyboardEvent) => {
                        ...
                        for (const hotkey of this.hotkeys) {
                                ...
                                const hotkeyKeys = hotkey.keys.map((k) =>
                                        k.toLowerCase(),
                                );
                                if (
                                        this.areKeysMatching(
                                                pressedKeys,
                                                hotkeyKeys,
                                        )
                                ) {
...
const iniData: HotKeysData = {
        ...
        hotkeys: [
                ...
                { 
                        ...
                        keys: ["Enter"],
                        description:
                                "Confirm and accept the current warning dialog",
                ...
                },
                {
                        ...
                        keys: ["Escape"],
                        description:
                                "Dismiss and deny the current warning dialog",
                        type: "System Controls",
                },
                {
                        name: "Reload App",
