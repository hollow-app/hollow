...
export default function DropDown({
        ...
        return (
                <div
                        ref={dropdownRef}
                        class="group pointer-events-auto relative w-70 max-w-full"
                        role="combobox"
                ...
                >
                        <input
                                ...
                                class="ease border-secondary-20 text-secondary-70 placeholder:text-secondary-40 hover:border-secondary-70 focus:border-primary w-full max-w-full appearance-none rounded-md border-2 bg-transparent py-2 pr-20 pl-3 text-sm shadow-sm transition duration-300 focus:shadow disabled:cursor-not-allowed disabled:opacity-50"
                                disabled={isLoading}
                                classList={{
                        ...
                        >
                                <ul
                                        ref={listRef}
                                        id="dropdown-list"
                                        class="bg-secondary-05 border-secondary-20 fixed z-50 mt-1 max-h-48 w-fit max-w-full overflow-x-hidden overflow-y-auto rounded-md border-2 text-sm shadow-lg"
                                        role="listbox"
                                                ...
                                                <For each={filteredItems()}>
                                                        {(item, index) => (
                                                                <li
                                                                        ...
                                                                        class="hover:bg-secondary-10 text-secondary-60 w-68 cursor-pointer bg-transparent px-3 py-2"
                                                                        classList={{
                                                                                "bg-secondary-10":
                                                                                        index() ===
                                                                                        activeIndex(),
