...
export default function Editor({ isVisible }: EditorProps) {
	const [kit, setKit] = createSignal<KitEditorType>(null);
		...
		<Sidepanel isVisible={isVisible}>
			...
			<Show when={kit()}>
				<div class="h-fit max-h-full overflow-hidden overflow-y-scroll pr-3 pl-[calc(var(--spacing)*3+8px)] text-gray-950 dark:text-gray-50">
					<h1 class="mt-12 text-2xl font-bold">Size</h1>
						...
						<div class="flex items-center justify-between">
							...
							<div class="toggle-switch">
								<input
									...
									checked={kit().glass}
									onclick={(e) =>
										kit().setGlass(e.currentTarget.checked)
									}
								/>
								<label
									class="toggle-label"
						...
						<div class="flex items-center justify-between">
							...
							<div class="toggle-switch">
								<input
									...
									checked={kit().shadow}
									onclick={(e) =>
										kit().setShadow(e.currentTarget.checked)
									}
								/>
								<label
									class="toggle-label"
