...
export default function ToolSettings({ pluginSettings }: ToolSettingsProps) {
        ...
        return (
                <div class="bg-secondary-05 border-secondary-15 shadow-popup pointer-events-auto absolute flex h-fit max-h-[70%] w-[60%] flex-col overflow-hidden rounded-2xl border-1 p-5">
                        <div class="flex h-fit min-h-40 gap-10 p-5">
                        ...
                        <hr class="border-secondary-10 h-px w-full border-dashed" />
