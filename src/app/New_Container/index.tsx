...
/**
 * Container component using proper SolidJS patterns
 * - Component is a function that returns JSX
 * - Hooks run within component context
 * - Reactivity is preserved through the entire tree
 */
const Container: Component<ContainerProps> = (props) => {
    // Use the custom hook - this runs in component context
