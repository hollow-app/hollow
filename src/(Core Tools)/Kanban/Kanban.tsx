...
export default function Kanban({ card, db, data, app }: KanbanProps) {
                ...
                const settings: ToolOptions = {
                        ...
                        options: [
...

                                {
                                        ...
                                        label: "Accent Color",
                                        description:
                                                "Change The Column's Accent Color",
                                        value: kanban().accent,
                                        onChange: (c: string) =>
                                                setKanban((prev) => ({
                                                        ...prev,
        ...
        return (
                ...
                >
                        ...
                        <div class="from-secondary absolute right-0 bottom-0 left-0 mb-4 opacity-0 bg-gradient-to-t to-transparent px-4 pt-16 @min-[10rem]:opacity-100">
                                <button
                                        class={
