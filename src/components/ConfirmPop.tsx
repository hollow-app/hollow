...
export default function ConfirmPop({ pack }: ConfirmPopProps) {
        ...
        return (
                <div class="bg-secondary-05 border-secondary-15 shadow-popup pointer-events-auto absolute h-fit w-fit max-w-[90%] rounded-xl border-1 p-10 text-gray-950 md:max-w-[60%] dark:text-gray-200">
